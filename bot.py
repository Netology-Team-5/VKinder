            ...
            if event.to_me:
                ...
                if request in ("Привет", 'привет', "хай", 'Йоу', 'Начать'):
                    ...
                    if len(list_of_fav) != 0:
                        write_msg(event.user_id, f'В вашем списке "Избранное" {len(list_of_fav)} человек.\n Вот они:',
                                  keyboard2.get_keyboard())
                        ...
                        write_msg(event.user_id, f'В вашем списке "Избранное" пусто.', keyboard2.get_keyboard())

...
if __name__ == '__main__':
    ...
    # new_db.table_creation('user_favorites', 'id SERIAL PRIMARY KEY, vk_user_id INTEGER NOT NULL REFERENCES vk_user(user_id_in_vk), fav_id INTEGER NOT NULL REFERENCES favorites(vk_user_id)')
